...
// BLANK= default application/logs/ or a full server path with trailing slash.

$config['log_path'] = '';

$config['log_date_format'] = 'Y-m-d H:i:s';

// BLANK =default : system/cache/ or a full server path with trailing slash.
...
| GMT.  See the 'date helper' page of the user guide for more informations
|
*/
